...
import shook.shook.legacy.voting_song.domain.repository.VoteRepository;
import shook.shook.legacy.voting_song.domain.repository.VotingSongPartRepository;
