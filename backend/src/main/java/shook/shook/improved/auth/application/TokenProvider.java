...
import shook.shook.improved.auth.exception.TokenException.ExpiredTokenException;
import shook.shook.improved.auth.exception.TokenException.NotIssuedTokenException;
...
public class TokenProvider {
    ...
    public Claims parseClaims(final String token) {
        try {
            ...
            throw new NotIssuedTokenException(Map.of("Token", token));
        } catch (ExpiredJwtException e) {
            throw new ExpiredTokenException(Map.of("Token", token));
        }
    }
}
