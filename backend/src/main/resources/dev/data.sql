...
insert into voting_song (title, artist_id, partLength, video_id, album_cover_url, created_at)
...
INSERT INTO song (title, artist_id, partLength, video_id, album_cover_url, genre, created_at)
